...
(function() {
  define('components/main_component',['react', 'components/keyword_card', 'models/keyword_collection', 'underscore', 'utils/backbone_mixin'], function(React, KeywordCard, KeywordCollection, _, BackboneMixin) {
