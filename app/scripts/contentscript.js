...
(function() {
  define('utils/on_selection',['jquery'], function($) {
...
define('utils/backbone_mixin',[], function(){
...
;
(function() {
  define('components/keyword_card',['react', 'utils/backbone_mixin'], function(React, BackboneMixin) {
...
(function() {
  ...
  define('models/searches/search_result',['backbone'], function(Backbone) {
    ...
    return SearchResult = (function(_super) {
      ...
      SearchResult.prototype.component = "SearchResultComponent";
...
(function() {
  ...
  define('models/searches/search_result_collection',['models/searches/search_result', 'backbone'], function(SearchResult, Backbone) {
...
(function() {
  ...
  define('models/searches/wikipedia_search',['backbone', 'jquery', 'models/searches/search'], function(Backbone, $, Search) {
...
(function() {
  ...
  define('models/searches/search_collection',['models/searches/search', 'models/searches/wikipedia_search', 'backbone'], function(Search, WikipediaSearch, Backbone) {
...
(function() {
  ...
  define('models/keyword',['backbone', 'models/searches/search_collection'], function(Backbone, SearchCollection) {
    var Keyword, _ref;
...
(function() {
  ...
  define('models/keyword_collection',['models/keyword', 'backbone'], function(Keyword, Backbone) {
...
(function() {
  define('components/main_component',['react', 'components/keyword_card', 'models/keyword_collection', 'underscore', 'utils/backbone_mixin', 'jquery', 'pep'], function(React, KeywordCard, KeywordCollection, _, BackboneMixin, $, pep) {
