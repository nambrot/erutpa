...
define [
  ...
  class LocationSearchResult extends SearchResult
    ...
    lat: ->
      ...
      return parseInt(@attributes.dbpediaData.data["http://www.georss.org/georss/point"][0].value.split(" ")[0]) if @attributes.dbpediaData.data["http://www.georss.org/georss/point"]
    ...
    lng: ->
      ...
      return parseInt(@attributes.dbpediaData.data["http://www.georss.org/georss/point"][0].value.split(" ")[1]) if @attributes.dbpediaData.data["http://www.georss.org/georss/point"]
    ...
    getZoomLevel: ->
      ...
      return (Math.log(133315101.0 / Math.sqrt(area)) / Math.log(2)) - 2 if area
