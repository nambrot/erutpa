  ...
  define(['jquery'], function($) {
    return function(callback) {
      return $(function() {
        ...
        $('body').on('mouseenter.erutpa', '.erutpa-learn-more-button', (function(_this) {
          return function() {
            var sel;
        ...
        $('body').on('mouseleave.erutpa', '.erutpa-learn-more-button', (function(_this) {
          return function() {
            var sel;
            sel = window.getSelection();
            sel.removeAllRanges();
        ...
        $('body').on('click.erutpa', '.erutpa-learn-more-button', (function(_this) {
          return function(evt) {
            var sel;
            sel = window.getSelection();
